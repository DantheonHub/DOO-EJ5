namespace DOO_EJ5
{
    ...
    public class ComputadoraVirtual()
    {
...
De proceso de datos.
De Aplicación.
Las de proceso son instancias que nos permitirán realizar procesos, por ejemplo, clonar bases de datos,
filtrarlas y almacenarlas dentro de otra por lo que queremos almacenar:
Datos de origen.
Datos de fin.
...
y que posee acceso a “datos de origen almacenados” y a “datos de fin almacenados”.
